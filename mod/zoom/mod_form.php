    ...
    public function definition() {
        ...
        if ($showschedulingprivilege || $showalternativehosts) {
          ...
          //  if ($showschedulingprivilege) {
            $choices = array();
        $choices['ashish@takshilalearning.com'] = "Ashish Anand"; 
        $choices['dhruv@takshilalearning.com'] = "Dhruv Mahajan"; 
        $choices['gopal@takshilalearning.com'] = "Gopal Krishna";  

                $mform->addElement('select', 'schedule_for', get_string('schedulefor', 'zoom'), $choices);
        ...
        // Select host id from the dropdown list (will error if user does not have an account on Zoom).
       /* $choices = array();
        $choices['ashish@takshilalearning.com'] = "Ashish Anand"; 
        $choices['dhruv@takshilalearning.com'] = "Dhruv Mahajan"; 
        $choices['gopal@takshilalearning.com'] = "Gopal Krishna";  */

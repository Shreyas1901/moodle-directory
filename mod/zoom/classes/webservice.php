...
class mod_zoom_webservice {
    ...
    public function receive_schedule_for_users($identifier) {

        $schedulers = [];
        
        $schedulers["Gopal Krishna"] = "gopal@takshilalearning.com";
        $schedulers["Ashish Anand"] = "ashish@takshilalearning.com";
        $schedulers["Dhruv Mahajan"] = "dhruv@takshilalearning.com";
